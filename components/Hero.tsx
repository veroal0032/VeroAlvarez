    ...
    <>
      ...
      >
        <div style={{ position: 'relative', width: '100%', height: '100%' }}>
          ...
          <div style={{ position: 'absolute', top: '261px', left: 0, right: 0, width: '1440px', height: 'fit-content' }}>
            ...
            {/* NOMBRE */}
            <div style={{ position: 'absolute', top: '33px', left: '255px', zIndex: 2 }}>
          ...
          {/* TAG OPEN TO WORK — top: 204px, left: 255px */}
          <motion.div
            {...floatY(3.5, 0.5)}
            style={{ position: 'absolute', top: '204px', left: '255px', background: '#CFA2FC', color: '#4a0080', fontFamily: 'var(--font-inter)', fontWeight: 600, fontSize: '12px', padding: '6px 14px', borderRadius: '100px', zIndex: 3, whiteSpace: 'nowrap' }}
          >
      ...
      >
        ...
        <div style={{ position: 'absolute', top: '55px', left: 0, right: 0, width: '100%' }}>
          ...
          <div style={{ position: 'absolute', top: '76px', left: '50%', transform: 'translateX(-50%)' }}>
            <motion.div
              {...floatY(3.5, 0.5)}
              style={{ background: '#CFA2FC', color: '#4a0080', fontFamily: 'var(--font-inter)', fontWeight: 600, fontSize: '12px', padding: '6px 14px', borderRadius: '100px', display: 'inline-flex', alignItems: 'center', gap: '6px', whiteSpace: 'nowrap' }}
            >
              <span style={{ width: '6px', height: '6px', borderRadius: '50%', background: '#7B00FF', display: 'inline-block' }} />
              Open to work
              <span>✦</span>
          ...
          <div style={{ position: 'absolute', top: '290px', left: '50%', transform: 'translateX(-50%)' }}>
            <motion.p
              {...floatY(4, 1.5)}
              style={{ color: '#999', fontFamily: 'var(--font-inter)', fontWeight: 400, fontSize: '12px', letterSpacing: '0.02em', margin: 0, whiteSpace: 'nowrap' }}
            >
              {timeStr}
            </motion.p>
          </div>
