...
const projects: Project[] = [
  ...
  },
  {
    ...
    type: "Residencial",
    description:
      "Complete architectural plans set for the Quintas B11 residential complex. Full drawing package of 91 sheets: floor plans, sections, elevations, reflected ceiling plans and construction details.",
    software: ["AutoCAD"],
    layout: "triple",
    images: [
